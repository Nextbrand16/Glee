...
function Check-SCCMAgent {
    $sccmAgent = Get-Service -Name "CcmExec" -ErrorAction SilentlyContinue
...
function Check-WindowsDefenderTraffic {
...
function Check-CarbonBlackAgent {
    $cbAgent = Get-Service -Name "CarbonBlack" -ErrorAction SilentlyContinue
